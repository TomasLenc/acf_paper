...
p_fft_high_z <- plot_subtr_effect(df, method='fft', pats=c(18))
p_acf_high_z <- plot_subtr_effect(df, method='acf', pats=c(8))
# pick a pattern with low negative true zscore
p_fft_low_z <- plot_subtr_effect(df, method='fft', pats=c(10))
p_acf_low_z <- plot_subtr_effect(df, method='acf', pats=c(1))
...
fname_eeg <- 'exp-lowhigh_apFitMethod-irasa_onlyHarm-true_roi-front_eegIndividual.csv'
...
fname_lowhigh <- 'exp-lowhigh_apFitMethod-irasa_onlyHarm-true_roi-front_eegIndividual.csv'
