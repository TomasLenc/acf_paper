...
if (str_detect(data_path, 'meterUnrel-0.6_1.0_1.4')){
    ctrl_selection_dir <- 'maxlag-11lags_meterRel-0.8_meterUnrel-0.6_1.0_1.4'
} else if (str_detect(data_path, 'meterUnrel-0.2')){
    ctrl_selection_dir <- 'maxlag-11lags_meterRel-0.8_meterUnrel-0.2'
} else {
    stop('cannot figure out selection dir for 11 lags control analysis....')
}
