...
fname <- 'irType-square_apFitMethod-fooof_nrep-50_noiseEffectACFvsFFT.csv'
df <- read.csv(file.path(data_path, fname))
df$pat <- factor(df$pat)

df$z_meter_fft_subtr_err <- (df$z_meter_fft_subtr - df$z_meter_fft_orig)
df$z_meter_acf_subtr_err <- (df$z_meter_acf_subtr - df$z_meter_acf_orig)
