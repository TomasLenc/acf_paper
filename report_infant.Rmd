...
#                                   sprintf('exp-infant_apFitMethod-%s_eegBoot.csv', ap_fit_method)))
# 
# df_eeg_grand <- read.csv(file.path(data_path, 
#                                   sprintf('exp-infant_apFitMethod-%s_eegGrand.csv', ap_fit_method)))

df_eeg_ind <- read.csv(file.path(data_path, 
                                  sprintf('exp-infant_apFitMethod-%s_eegIndividual.csv', ap_fit_method)))
...
par_matlab <- drop(readMat(file.path(data_path,
                                  sprintf('exp-infant_apFitMethod-%s_eegIndividual_par.mat',
...
After subtracting the 1/f, acf was computed and averaged across **frontocentral** channels, separately for each participant.  
