...
for i_cond=1:n_cond
    ...
    if plot_example_fig      
        ...
        pnl_example(i_cond).margintop = 28; 
    end

end

if save_figs
   fname = sprintf('figures/05_emph_irType-%s_exp-%.1f_snr-%.1f_nrep-%d_examples.svg', ...
...
for i_cond=cond_to_plot
    ...
    for i_ax=1:length(pnl.children)
     ...
     if save_figs
       saveas(f, sprintf('figures/05_emph_irType-%s_exp-%.1f_snr-%.1f_nrep-%d_%s_%s.svg', ...
