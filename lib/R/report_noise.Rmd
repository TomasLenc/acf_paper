...
# apply r-to-z to all relevant columns 
...
data_path <- file.path(experiment_path, 'data', 'maxlag-11lags_meterUnrel-0.6_1.0_1.4')
...
# take absolute value of the correlation coefficient? 
...
ggplot() +
    ...
    ylab('abs corr (r) with ground truth') + 
    theme_cowplot() +
    scale_x_reverse() 
