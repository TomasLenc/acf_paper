function main_noise_dist_correction_steps(par, varargin)
% Simulate the correlation between ACF values at lags of interest taken
% from a noise-free ground truth version of a signal, and noisy version.
% The idea is to check how well we can reconstruct ACF values of
% ground-truth signal under different levels of noise, if we take raw,
% 1/f-subtracted, and noise-zeroed-out ACF estimate. 
...
% save table
fname = sprintf('irType-%s_apFitMethod-%s_noiseEffectDistCorrection', ...
                par.ir_type, ...
                par.ap_fit_method); 
