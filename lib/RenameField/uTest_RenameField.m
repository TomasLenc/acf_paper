...
% $JRev: R-u V:020 Sum:Hs5KzM4Kz8K2 Date:02-Aug-2021 19:41:32 $
...
if CheckEnabled
   ...
   if tooLazy
      error([ErrID, 'InvalidNameAccepted'], 'CHAR+Cell input accepted!');
   end
   ...
   if tooLazy
      error([ErrID, 'InvalidNameAccepted'], 'Cell+CHAR input accepted!');
   end
...
fprintf('CHAR - rename 1 field of a struct:  (%d loops)\n', nLoop);
